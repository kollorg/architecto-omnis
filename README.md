[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2Fmoia-oss%2Fbastion-host-forward%2Fbadge&style=flat)](https://actions-badge.atrox.dev/kollorg/architecto-omnis/goto)
...
```
npm install @kollorg/architecto-omnis
```
...
import { BastionHostRDSForward } from '@kollorg/architecto-omnis';
...
```typescript
import * as cdk from '@aws-cdk/core';
import { GenericBastionHostForward } from '@kollorg/architecto-omnis';
import { SecurityGroup, Vpc } from '@aws-cdk/aws-ec2';
